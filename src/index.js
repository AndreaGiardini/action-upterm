...
export async function run() {
  try {
    ...
    if (process.platform == "linux") {
      await execShellCommand("curl -sL https://github.com/owenthereal/upterm/releases/download/v0.7.5/upterm_linux_amd64.tar.gz | tar zxvf - -C /tmp upterm && sudo install /tmp/upterm /usr/local/bin/")
